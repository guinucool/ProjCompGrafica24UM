...
#include "../../../inc/transforms/constant/transform.hpp"
...
namespace transforms::constant
{
    ...
    bool Transform::operator==(const transforms::Transform * transform) const {
        ...
        /* Transforma a transformação em transformação estática */
        Transform * con = (Transform *) transform;

        /* Verificação de igualdade */
        return ((typeid(*this) == typeid(*transform)) && (this->x == con->x) && (this->y == con->y) && (this->z == con->z));
    }
